...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample05">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown05">
            <a class="dropdown-item" href="view/formUsuario.php">Cadastro</a>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Produto</a>
          <div class="dropdown-menu" aria-labelledby="dropdown05">
            <a class="dropdown-item" href="view/formProduto.php">Cadastro</a>
            <a class="dropdown-item" href="view/relatorioTelaProduto.php">Relatório Geral</a>
          </div>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown05">
            <a class="dropdown-item" href="view/formCompra.php">Realizar Compra</a>
            <a class="dropdown-item" href="view/relatorioCompra.php">Relatório Geral</a>
          </div>
        </li>
      ...
      <?php
      if ($_SESSION["id"]) {
        echo "<a href=view/alterarPerfil.php?id=$_SESSION[id]>";
      ?>
